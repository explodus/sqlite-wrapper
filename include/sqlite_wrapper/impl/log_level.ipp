...
inline db::log::singleton::db::log_type &
  ...
  static log_type ret(boost::make_shared< provider_type >(boost::make_shared< buffer_type >(name)));
  return ret;
}

inline db::log::singleton::basic::log_type & db::log::singleton::basic::get_log() {
  static log_type ret(boost::shared_ptr< provider_type >(
    new provider_type(boost::shared_ptr< buffer_type >(new buffer_type))));
  return ret;
}
