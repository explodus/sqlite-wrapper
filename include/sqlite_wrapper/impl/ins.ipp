...
SQLITE_WRAPPER_INLINE db::ins::ins(const string & tab)
  : _source(tab) {
}

SQLITE_WRAPPER_INLINE db::ins::ins(const string & tab, const string & delim)
  : _source(tab)
  , _delim1(delim)
  , _delim2(delim) {
}

SQLITE_WRAPPER_INLINE db::ins::ins(const string & tab, const string & delim1, const string & delim2)
  : _source(tab)
  , _delim1(delim1)
  , _delim2(delim2) {
}
